...
module.exports = class Undefined1736442620782 {
    name = 'Undefined1736442620782'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "text" character varying NOT NULL, "sended_at" TIMESTAMP WITH TIME ZONE NOT NULL, "sender_id" uuid NOT NULL, "receiver_id" uuid NOT NULL, "receiver_sector_id" uuid, "solicitation_id" uuid NOT NULL, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "attachment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file_name" character varying NOT NULL, "mime_type" character varying NOT NULL, "data" bytea NOT NULL, "solicitation_id" uuid NOT NULL, CONSTRAINT "PK_d2a80c3a8d467f08a750ac4b420" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "solicitations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "solicitation_name" character varying NOT NULL, CONSTRAINT "PK_53503efa9bcfa87b80700677e88" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "solititation_users" ("solicitation_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_af27f7d276349e540cc213becac" PRIMARY KEY ("solicitation_id", "user_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_316a9fee627f66ac1d301c0685" ON "solititation_users" ("solicitation_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_5ad0a74579ecc50de4cae4d9a6" ON "solititation_users" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_5981c93e0575cfd815806b292bf" FOREIGN KEY ("solicitation_id") REFERENCES "solicitations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "attachment" ADD CONSTRAINT "FK_e8beaac14689e3348c19bda986b" FOREIGN KEY ("solicitation_id") REFERENCES "solicitations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "solititation_users" ADD CONSTRAINT "FK_316a9fee627f66ac1d301c0685a" FOREIGN KEY ("solicitation_id") REFERENCES "solicitations"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "solititation_users" ADD CONSTRAINT "FK_5ad0a74579ecc50de4cae4d9a64" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "solititation_users" DROP CONSTRAINT "FK_5ad0a74579ecc50de4cae4d9a64"`);
        await queryRunner.query(`ALTER TABLE "solititation_users" DROP CONSTRAINT "FK_316a9fee627f66ac1d301c0685a"`);
        ...
        await queryRunner.query(`ALTER TABLE "attachment" DROP CONSTRAINT "FK_e8beaac14689e3348c19bda986b"`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_5981c93e0575cfd815806b292bf"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5ad0a74579ecc50de4cae4d9a6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_316a9fee627f66ac1d301c0685"`);
        await queryRunner.query(`DROP TABLE "solititation_users"`);
