...
module.exports = class Initial1728490949776 {
    name = 'Initial1728490949776'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "user_grants" ("user_id" uuid NOT NULL, "grant_id" uuid NOT NULL, CONSTRAINT "PK_86e223d7a5afcad976727b84706" PRIMARY KEY ("user_id", "grant_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e0333ccd9114cfde7d3cc64508" ON "user_grants" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_baf9c35ceaf2537d3e0847f98b" ON "user_grants" ("grant_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_grants" ADD CONSTRAINT "FK_e0333ccd9114cfde7d3cc64508f" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_grants" ADD CONSTRAINT "FK_baf9c35ceaf2537d3e0847f98b9" FOREIGN KEY ("grant_id") REFERENCES "grants"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "user_grants" DROP CONSTRAINT "FK_baf9c35ceaf2537d3e0847f98b9"`);
        await queryRunner.query(`ALTER TABLE "user_grants" DROP CONSTRAINT "FK_e0333ccd9114cfde7d3cc64508f"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_baf9c35ceaf2537d3e0847f98b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e0333ccd9114cfde7d3cc64508"`);
        await queryRunner.query(`DROP TABLE "user_grants"`);
