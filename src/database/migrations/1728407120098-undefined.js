...
module.exports = class Undefined1728407120098 {
    name = 'Undefined1728407120098'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "chats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
