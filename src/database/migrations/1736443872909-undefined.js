...
module.exports = class Undefined1736443872909 {
    name = 'Undefined1736443872909'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "PK_0428f484e96f9e6a55955f29b5f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "text" character varying NOT NULL, "sended_at" TIMESTAMP WITH TIME ZONE NOT NULL, "sender_id" uuid NOT NULL, "receiver_id" uuid NOT NULL, "receiver_sector_id" uuid, "chat_id" uuid NOT NULL, "request_id" uuid NOT NULL, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "request_users" ("request_id" uuid NOT NULL, "user_id" uuid NOT NULL, CONSTRAINT "PK_a7d02e206cc1852712e269ac161" PRIMARY KEY ("request_id", "user_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_70ed5786b2f43c5f5020c7f948" ON "request_users" ("request_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_fa2bfe122c6372303f4af09d2c" ON "request_users" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_4974811f87523f7c84e557c4d0c" FOREIGN KEY ("request_id") REFERENCES "requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "request_users" ADD CONSTRAINT "FK_70ed5786b2f43c5f5020c7f9482" FOREIGN KEY ("request_id") REFERENCES "requests"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "request_users" ADD CONSTRAINT "FK_fa2bfe122c6372303f4af09d2c2" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "request_users" DROP CONSTRAINT "FK_fa2bfe122c6372303f4af09d2c2"`);
        await queryRunner.query(`ALTER TABLE "request_users" DROP CONSTRAINT "FK_70ed5786b2f43c5f5020c7f9482"`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_4974811f87523f7c84e557c4d0c"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fa2bfe122c6372303f4af09d2c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_70ed5786b2f43c5f5020c7f948"`);
        await queryRunner.query(`DROP TABLE "request_users"`);
